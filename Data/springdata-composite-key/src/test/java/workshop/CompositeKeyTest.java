...
public class CompositeKeyTest {
	...
	public void create() {
		...
		Employee subodh = new Employee("Subodh", "subodh@gmail.com");
		EmployeeIdentity subodhIdentity = new EmployeeIdentity("E-100", "O-100");
		subodh.setId(subodhIdentity);

		Employee juli = new Employee("Juli", "juli@gmail.com");
		EmployeeIdentity juliIdentity = new EmployeeIdentity("E-100", "O-101");
